...
<div class="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
		...
		<DialogContent>
			...
			{:else}
				<div class="flex flex-col gap-3">
					{#each data.currentViewers as viewer (viewer.userId)}
						<div class="flex items-center gap-3">
							<span class="size-2 shrink-0 rounded-full bg-online" aria-label="Právě online"></span>
							<Avatar size="sm">
								<AvatarFallback>
	...
	<Dialog>
		...
		<DialogContent>
			...
			{:else}
				<div class="flex flex-col gap-3">
					{#each data.allViewers as viewer (viewer.userId)}
						<div class="flex items-center gap-3">
							<span
		...
		<DialogContent class="sm:max-w-xl">
			...
			{:else}
				<div class="flex max-h-72 flex-col gap-3 overflow-y-auto">
					{#each data.liveViewers as viewer (viewer.userId)}
						<div class="flex items-center gap-3">
							<Avatar size="sm">
								<AvatarFallback>
									<UserRound class="size-4" />
